...
filename = f"/workspace/catalyst/fused_moe/moe_fp8_block_scale_ds_routing_topk8_ng8_kg4_e32_h7168_i2048.jsonl"
...
for entry in kept:
    ...
    full_tensor_path = os.path.join(f"/workspace/catalyst/fused_moe", tensor_basename)
    blob_dir = f"/workspace/catalyst/blob/"
